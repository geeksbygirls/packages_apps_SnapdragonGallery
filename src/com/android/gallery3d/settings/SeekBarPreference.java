...
public class SeekBarPreference extends Preference implements OnSeekBarChangeListener {
    ...
    private static final String CUSTOM = "http://schemas.android.com/apk/res/org.codeaurora.gallery";
    ...
    private void setValuesFromXml(AttributeSet attrs) {
        ...
        mMinValue = attrs.getAttributeIntValue(CUSTOM, "min", 0);
        mUnitsLeft = getAttributeStringValue(attrs, CUSTOM, "unitsLeft", "");
        String units = getAttributeStringValue(attrs, CUSTOM, "units", "");
        mUnitsRight = getAttributeStringValue(attrs, CUSTOM, "unitsRight", units);
        ...
        try {
            String newInterval = attrs.getAttributeValue(CUSTOM, "interval");
            if(newInterval != null)
